...
var axes = svg.selectAll(".axis")
  ...
  var file_name = "data/coord.csv"

create_coord(file_name,dimensions,ctx,xscale,axes,yAxis,output,svg)
...
function create_coord (file_name,dimensions,ctx,xscale,axes,yAxis,output,svg){
